...
export const WHISPER_MODELS: Record<string, WhisperModelConfig> = {
  tiny: {
    ...
    name: 'Tiny (fastest)',
    size: 'tiny',
    onnxModelId: 'onnx-community/whisper-tiny_timestamped',
    estimatedSizeMB: 40,
  ...
  base: {
    ...
    name: 'Base (balanced)',
    size: 'base',
    onnxModelId: 'onnx-community/whisper-base_timestamped',
    estimatedSizeMB: 75,
  ...
  small: {
    ...
    size: 'small',
    onnxModelId: 'onnx-community/whisper-small_timestamped',
    estimatedSizeMB: 250,
  ...
  medium: {
    ...
    size: 'medium',
    onnxModelId: 'onnx-community/whisper-medium_timestamped',
    estimatedSizeMB: 780,
